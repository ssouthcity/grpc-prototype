...
type CarServiceClient interface {
	GetCar(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Car, error)
}
...
func (c *carServiceClient) GetCar(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Car, error) {
	out := new(Car)
...
type CarServiceServer interface {
	GetCar(context.Context, *empty.Empty) (*Car, error)
...
func (UnimplementedCarServiceServer) GetCar(context.Context, *empty.Empty) (*Car, error) {
...
func _CarService_GetCar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarServiceServer).GetCar(ctx, req.(*empty.Empty))
	}
